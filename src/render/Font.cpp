...
int16 CFont::Size[MAX_FONTS][210] = {
#endif
	{
		//FONT2 EFIGS
		#ifdef LANGUAGE_RUS
		 5,  9,  9,  0, 17, 17, 23,  3, //   0 ! ! " # $ % & '
		21, 18,  0,  8,  3,  8,  3,  0, //   8 ( ) * + C - . /
		16,  9, 16, 16, 15, 19, 15, 14, //  16 0 1 2 3 4 5 6 7
		17, 17,  4,  4,  0,  0,  0, 17, //  24 8 9 : ; < = > ?
		19, 17, 19, 15, 21, 18, 19, 16, //  32 - A B C D E F G
		21, 13, 15, 21, 20, 28, 21, 18, //  40 H I J K L M N O
		22, 17, 21, 20, 18, 18, 20, 26, //  48 P Q R S T U V W
		22, 18, 18,  0,  8,  0,  9,  8, //  56 X Y Z [ \ ] ^ _
		0,  14, 11, 12, 16, 11, 13, 13, //  64 ` a b c d e f g
		15, 10, 14, 15, 11, 21, 17, 10, //  72 h i j k l m n o
		20, 15, 12, 12, 16, 17, 13, 16, //  80 p q r s t u v w
		13, 21, 11,  0,  0,  0,  0,  0, //  88 x y z { | } ~ 
		20, 19, 19, 22, 27, 15, 18, 18, //  96 À Á Â Ã Æ Ç È É
		20, 26, 21, 23, 17, 22, 21, 17, // 104 Ê Ë Ì Í Î Ï Ò Ó
		26, 25, 26, 17, 20, 26, 17, 16, // 112 Ô Ö Ù Ú Û Ü ß à
		11, 12, 13, 21, 11, 17, 17, 12, // 120 á â ã æ ç è é ê
		21, 17, 17, 15, 24, 16, 10, 20, // 128 ë ì í î ï ò ó ô
		23, 16,  7,  9, 16, 23, 12, 11, // 136 ö ù ú û ü N n ?
	...
	},
	{
		//FONT1 EFIGS
		#ifdef LANGUAGE_RUS
		11,  5, 10, 15, 19, 22, 20,  5, // 0 ! ! " # $ % & '
		 9,  8, 11, 12,  5, 12,  6, 12, // 8 ( ) * + C - . /
		19,  5, 18, 19, 20, 18, 19, 18, // 16 0 1 2 3 4 5 6 7
		20, 19,  5,  6, 26, 12, 30, 19, // 24 8 9 : ; < = > ?
		23, 21, 20, 20, 20, 16, 16, 21, // 32 - A B C D E F G
		19,  5, 13, 19, 16, 24, 20, 21, // 40 H I J K L M N O
		20, 21, 20, 19, 17, 20, 21, 30, // 48 P Q R S T U V W
		22, 21, 20,  8, 12,  8,  5,  9, // 56 X Y Z [ \ ] ^ _
		10, 15, 15, 14, 15, 16, 10, 15, // 64 ` a b c d e f g
		15,  5,  5, 15,  5, 23, 15, 16, // 72 h i j k l m n o
		15, 15,  9, 16, 10, 15, 17, 24, // 80 p q r s t u v w
		18, 15, 15, 27,  5, 19,  2,  2, // 88 x y z { | } ~ 
		20, 20, 16, 23, 30, 19, 20, 20, // 96 À Á Â Ã Æ Ç È É
		21, 24, 19, 19, 20, 23, 22, 19, // 104 Ê Ë Ì Í Î Ï Ò Ó
		27, 29, 25, 20, 20, 28, 24, 16, // 112 Ô Ö Ù Ú Û Ü ß à
		16, 14, 19, 25, 16, 16, 16, 17, // 120 á â ã æ ç è é ê
		19, 16, 16, 17, 25, 19, 15, 23, // 128 ë ì í î ï ò ó ô
		26, 21, 16, 14, 22, 20, 16, 19, // 136 ö ù ú û ü N n ?
		15, 14, 15, 16, 17, 15, 15, 15, // 144 0 1 2 3 4 5 6 7
		15, 15,  7, 15, 15, 15, 15, 15, // 152 8 9 : a b c d e
		13, 15, 15,  7, 15, 16, 13, 23, // 160 f g h i j k l m
		15, 15, 15, 15, 15, 15, 17, 15, // 168 n o p q r s t u
		16, 24, 17, 17, 17, 15, 15, 13, // 176 v w x y z À Á Â
		20, 23, 15, 17, 17, 16, 24, 15, // 184 Ã Æ Ç È É Ê Ë Ì
		15, 15, 23, 18, 15, 23, 26, 23, // 192 Í Î Ï Ò Ó Ô Ö Ù
		16, 15, 23, 15, 15, 19,  2,  2, // 200 Ú Û Ü ß Ñ ¿ ' .
		10, // [REPLACEMENT_SPACE_CHAR]
		20  // [UNPROP]
		#else
